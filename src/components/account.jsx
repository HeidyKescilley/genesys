        ...
        <section>
            ...
            >
                <div className=" mx-auto max-w-2xl sm:text-center">
                    <Title
                        title="A hora de transformar suas finanças é agora."
                        className="text-2xl"
                    />
                    <p className="mt-2 text-lg text-gray-600">
                        Desde o controle de fluxo de caixa até a automação de processos,
                        oferecemos soluções integradas que garantem eficiência, conformidade e crescimento sustentável.
                    </p>
                </div>
                <ul
                    role="list"
